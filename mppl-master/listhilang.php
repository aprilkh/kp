            ...
            <h1>LIST BARANG HILANG</h1>
                <div class="row">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <a href="<?php echo "detailkehilangan.php?id=$ID_Barang[$i]"?>">
                            <img src="img/<?php echo $Foto[$i] ?>" style="width:320px; height:150px;" alt="Barang">
                            </a>
                            <div class="caption">
                                <!-- <h4 class="pull-right">$24.99</h4> -->
                                <h4><a href="<?php echo "detailkehilangan.php?id=$ID_Barang[$i]"?>"><?php echo $nama_barang[$i]?></a></h4>
                                <p>
                                    <a href="<?php echo "detailkehilangan.php?id=$ID_Barang[$i]"?>" class="btn btn-primary">Detail</a>
                                    <a data-target="#<?php echo $ID_Barang[$i]?>" data-toggle="modal" class="btn btn-list">Klaim</a>
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content animate">
                                <div class="modal-header">
                                  ...
                                  <h4 style="color:white;" class="modal-title"><span class="glyphicon glyphicon-envelope"></span> Klaim Barang</h4>
                                </div>
                                <div class="modal-body">
                                ...
                                <div class="col-md-12">
                                <div class="col-md-3">
                                <strong class="text-primary">Pertanyaan </strong>
                                </div>
