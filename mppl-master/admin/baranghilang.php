...
<!--                                     <li><a href="#"><i class="ti-user"></i> Profile</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Barang Hilang</h4>
                                <h6 class="card-subtitle">Data table kehilangan barang</h6>
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                              include 'konek.php';
                                              $query = "SELECT barang.`ID_Barang`, barang.`ID_User`, barang.`Nama_Barang`, barang.`Tanggal`, barang.`Tempat`, transaksi.`Status`
                                                FROM barang, transaksi
                                                WHERE barang.`ID_Barang`=transaksi.`ID_Barang` AND barang.`Kategori`='Kehilangan' ";
                                              ...
                                              while($data = mysqli_fetch_assoc($result))
                                              {
                                                ...
                                                echo "<td>$tpt</td>";
                                                echo "<td>$stat</td>";
                                                echo '<td><a href="#" data-href="hilang-hapus.php?id='.$id.'" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o fa-lg"></i></a></td>';
                                                 //menampilkan 
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2019 All rights reserved. ITS LnF Admin Page</a></footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
