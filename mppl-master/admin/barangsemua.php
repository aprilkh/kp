                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Data table barang kehilangan dan temuan</h6>
                                        ...
                                        <tbody>
                                            <?php
                                              ...
                                              while($data = mysqli_fetch_assoc($result))
                                              {
                                                ...
                                                echo "<td>$ktg</td>";
                                                echo "<td>$stat</td>";
                                                echo '<td><a href="#" data-href="semua-hapus.php?id='.$id.'" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o fa-lg"></i></a></td>';
                                                 //menampilkan 
