            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Barang Temuan</h4>
                                <h6 class="card-subtitle">Data table barang temuan</h6>
                                        ...
                                        <tbody>
                                            <?php
                                              ...
                                              $query = "SELECT barang.`ID_Barang`, barang.`ID_User`, barang.`Nama_Barang`, barang.`Tanggal`, barang.`Tempat`, transaksi.`Status`
                                                ...
                                                WHERE barang.`ID_Barang`=transaksi.`ID_Barang` AND barang.`Kategori`='Ditemukan' ";
                                              ...
                                              while($data = mysqli_fetch_assoc($result))
                                              {
                                                ...
                                                echo "<td>$tpt</td>";
                                                echo "<td>$stat</td>";
                                                echo '<td><a href="#" data-href="temuan-hapus.php?id='.$id.'" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o fa-lg"></i></a></td>';
                                                 //menampilkan 
