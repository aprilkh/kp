            ...
            <h1>LIST BARANG TEMUAN</h1>
                <div class="row">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <a href="<?php echo "detailtemuan.php?id=$ID_Barang[$i]"?>">
                            <img src="img/<?php echo $Foto[$i] ?>" style="width:320px; height:150px;" alt="Barang">
                            </a>
                            <div class="caption">
                                <!-- <h4 class="pull-right">$24.99</h4> -->
                                <h4><a href="<?php echo "detailtemuan.php?id=$ID_Barang[$i]"?>"><?php echo $nama_barang[$i]?></a></h4>
                                <p>
                                    <a href="<?php echo "detailtemuan.php?id=$ID_Barang[$i]"?>" class="btn btn-primary">Detail</a>
