...
class M_pengaduan extends CI_Model {
	...
	{
		$q = $this->db->query("SELECT * FROM mahasiswa, pengaduan
								WHERE mahasiswa.nik = pengaduan.nik
								");	
		return $q;
	}
	...
	{
		$q = $this->db->query("SELECT * FROM pengaduan, admin, mahasiswa
								WHERE pengaduan.id_admin = admin.id_admin
								AND pengaduan.nik = mahasiswa.nik
