...
class Pengaduan extends CI_Controller {
	...
	{
		$data['judul'] 		= 'Keluhan mahasiswa >> Data Keluhan';
    ...
    {
        $user = $this->session->userdata('userdata_desa');
        $data['judul']      = "Keluhan mahasiswa >> Data Keluhan ".$user['nama'];
        $data['aktif']      = 'data';
    ...
    {
        $data['judul']      = 'Keluhan mahasiswa >> Input Data Keluhan';
        $data['aktif']      = 'input';
    ...
    {
        $data['judul']      = 'Keluhan mahasiswa >> Keluhan >> Detail';
        $data['aktif']      = 'data';
    ...
    {
        $data['judul']      = 'Keluhan mahasiswa >> Edit Data Keluhan';
        $data['aktif']      = 'data';
        $data['pengaduan']  = $this->M_pengaduan->get_id($id_pengaduan)->row_array();
