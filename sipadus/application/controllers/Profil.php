...
class Profil extends CI_Controller {
    ...
    {
        $data['judul']      = 'Keluhan mahasiswa >> Edit Profil';
        $data['aktif']      = 'profil';
        $data['profil']     = $this->M_mahasiswa->get_nik($nik)->row_array();
    ...
    {
        $data['judul']      = 'Keluhan mahasiswa >> Edit Akun';
        $data['aktif']      = 'akun';
        $data['profil']     = $this->M_mahasiswa->get_nik($nik)->row_array();
    ...
    public function edit_akun_proses($nik)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $cek_nik        = $this->db->query("SELECT * FROM mahasiswa WHERE nik = '$nik' ")->row_array();
