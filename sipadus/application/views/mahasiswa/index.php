...
<div id="main-container">
    ...
    <div id="page-content">
        ...
        <div class="block full">
            ...
            <a href="#modal-fade" title="Tambah Agama" class="btn btn-effect-ripple btn-info" data-toggle="modal"><i class="fa fa-plus"></i> Tambah mahasiswa</a>
            <br>
                    ...
                    <?php $no=0; foreach ($mahasiswa as $row): $no++?>
                        <tr>
                            ...
                            <td class="text-center" width="200px">
                                <a href="<?php echo site_url('mahasiswa/detail/'.$row->nik) ?>" data-toggle="tooltip" title="Detail <?php echo $row->nama ?>" class="btn btn-effect-ripple btn-warning"><i class="fa fa-search"></i></a>
                                <a href="<?php echo site_url('mahasiswa/edit/'.$row->nik) ?>" data-toggle="tooltip" title="Edit <?php echo $row->nama ?>" class="btn btn-effect-ripple btn-success"><i class="fa fa-pencil"></i></a>
                                <a href="<?php echo site_url('mahasiswa/hapus/'.$row->nik) ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus <?php echo $row->nama?>');" data-toggle="tooltip" title="Hapus <?php echo $row->nama ?>" class="btn btn-effect-ripple btn-danger"><i class="fa fa-times"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title"><strong><i class="fa fa-plus"></i> Tambah mahasiswa</strong></h3>
            </div>
            <div class="modal-body">
                <form id="form-validation" action="<?php echo site_url('mahasiswa/tambah_proses') ?>" method="POST" enctype="multipart/form-data">
