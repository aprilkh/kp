            ...
            <div class="block animation-fadeInQuickInv">
                ...
                <form id="form-validation" action="<?php echo site_url('Login/register_proses') ?>" method="post" class="form-horizontal">
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input type="text" id="val-number" name="val-number" class="form-control" placeholder="Masukkan NIM" autofocus autocomplete="off">
                            <span class="help-block">NB : NIM harus Sesuai dengan Data Asli</span>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Web ini adalah sarana untuk menampung keluhan dan aspirasi untuk LPPMP UNS</p>
                        <h4 class="page-header">2. <strong>Akun</strong></h4>
                        <p>Keluhan hanya dapat dilakukan oleh civitas akademik UNS</p>
