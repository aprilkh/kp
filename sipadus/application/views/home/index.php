<?php $this->load->view('header'); ?>
                ...
                <div id="main-container">
                    ...
                    <div id="page-content">
                        <!-- First Row -->
                        <h2 align="center">DIVISI LPPMP UNS</h2>
                         <div class="col-sm-6 col-lg-4">
                                <a href="javascript:void(0)" class="widget">
                                    <div class="widget-content widget-content-mini themed-background-dark-flat">
                                        ...
                                        <strong class="text-light-op">SERDOS</strong>
                                    </div>
                                    <div class="widget-content themed-background-flat clearfix">
                                        <span class="text-light-op">SERDOS adalah bagian</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-sm-6 col-lg-4">
                                <a href="javascript:void(0)" class="widget">
                                    <div class="widget-content widget-content-mini themed-background-dark-flat">
                                        ...
                                        <strong class="text-light-op">BKD</strong>
                                    </div>
                                    <div class="widget-content themed-background-flat clearfix">
                                        <span class="text-light-op">BKD adalah bagian</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-sm-6 col-lg-4">
                                <a href="javascript:void(0)" class="widget">
                                    <div class="widget-content widget-content-mini themed-background-dark-flat">
                                        ...
                                        <strong class="text-light-op">Kurikulum</strong>
                                    </div>
                                    <div class="widget-content themed-background-flat clearfix">
                                        <span class="text-light-op">Kurikulum adalah bagian</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-sm-6 col-lg-4">
                                <a href="javascript:void(0)" class="widget">
                                    <div class="widget-content widget-content-mini themed-background-dark-flat">
                                        ...
                                        <strong class="text-light-op">SPADA</strong>
                                    </div>
                                    <div class="widget-content themed-background-flat clearfix">
                                        <span class="text-light-op">SPADA adalah bagian</span>
                                    </div>
                                </a>
                            </div>
                            <!-- Simple Stats Widgets -->
                            <br><br><br><br><br><br><br><br><br><br><br><br>
                            <h2 align="center">KETERANGAN PENGADUAN</h2>
                            <div class="col-sm-6 col-lg-4">
                                <a href="javascript:void(0)" class="widget">
                                    <div class="widget-content widget-content-mini themed-background-dark-flat">
                                        <span class="pull-right text-muted">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <a href="javascript:void(0)" class="widget">
                                    ...
                                    <div class="widget-content themed-background-passion clearfix">
                                        ...
                                        <span class="text-light-op">PENGADUAN BELUM DIVERIFIKASI</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-sm-6 col-lg-4">
                                <a href="javascript:void(0)" class="widget">
                                    ...
                                    <div class="widget-content themed-background-success clearfix">
                                        ...
                                        <span class="text-light-op">PENGADUAN SUDAH DIVERIFIKASI</span>
                                    </div>
                                </a>
                            </div>
