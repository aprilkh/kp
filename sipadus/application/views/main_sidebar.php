                ...
                <div id="sidebar">
                    ...
                    <div id="sidebar-brand" class="themed-background-social">
                        <a href="<?php echo site_url('') ?>" class="sidebar-title">
                            <i class="fa fa-cube"></i> <span class="sidebar-nav-mini-hide"><strong>SIPADUS</strong></span>
                        </a>
                    </div>
                    <!-- END Sidebar Brand -->
                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li>
                                    <a href="<?php echo site_url('mahasiswa') ?>" class="<?php if($aktif == 'mahasiswa'){echo " active";} ?>">
                                        <i class="gi gi-user sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Data mahasiswa</span>
                                    </a>
                                </li>
